...
def get_memory_client(custom_instructions: None | str = None):
    """
    ...
    try:
        # let the config factory get config data for us
        config = get_parsed_memory_config(custom_instructions)
